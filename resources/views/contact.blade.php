        ...
        <form action="" method="post" class="max-w-xl mx-auto">
            ...
            <div class="md:flex items-center mt-12">
                <div class="md:w-72 flex flex-col">
                    ...
                    <input  arial-label="Please input name" type="text" class="text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100" placeholder="Please input  name" />
                </div>
                <div class="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                    ...
                    <input arial-label="Please input email address" type="email" class="text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100" placeholder="Please input email address" />
                </div>
            </div>
            ...
            <div>
                <div class="w-full flex flex-col mt-8">
                    ...
                    <textarea rows="5" aria-label="leave a message" class=" text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100"></textarea>
                </div>
            </div>
