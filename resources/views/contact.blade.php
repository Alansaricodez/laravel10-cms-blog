<x-app-layout>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li aria-current="page">
            <div class="flex items-center">
              /
              <span class="mx-1 text-sm font-medium text-gray-500 md:me-2 ">{{__('site.contact')}}</span>
            </div>
          </li>
        </ol>
      </nav>
    ...
    <div class="h-screen flex lg:flex-row flex-col justify-center align-middle shadow  py-8 lg:px-28 px-8 mx-auto">
        ...
        <p class="md:text-3xl text-xl lg:text-5xl my-6 lg:my-auto font-bold leading-7 text-center text-gray-700 uppercase">{{__('site.we_are_happy_to_hear_from_you')}}</p>
        ...
        <form action="{{route('send.message')}}" method="post" class=" md:mx-auto bg-white p-6 h-fit my-auto rounded mt-12 lg:mt-auto">
            ...
            <div class="md:flex items-center ">
                <div class="md:w-72 flex flex-col">
                    <label class="text-base font-semibold leading-none text-gray-80">{{__('site.name')}}</label>
                ...
                <div class="md:w-72 flex flex-col mx-3 md:me-6 md:mt-0 mt-4">
                    <label class="text-base font-semibold leading-none text-gray-800 ">{{__('site.email')}}</label>
            ...
            <div>
                <div class="w-full flex flex-col mt-8">
                    <label class="text-base font-semibold leading-none text-gray-800 ">{{__('site.message')}}</label>
            ...
            <div class="flex items-center justify-center w-full">
                <button class="mt-9 text-base font-semibold leading-none text-white py-4 px-10 bg-indigo-700 rounded hover:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none">{{__('site.submit')}}</button>
            </div>
