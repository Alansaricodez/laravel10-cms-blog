                ...
                <div class="flex lg:ms-3">
                    ...
                    <div class="hidden sm:mx-3 md:flex" >                            
                        <x-nav-link >
                            ...
                            <button id="dropdownHoverButton" data-dropdown-toggle="dropdownHover" data-dropdown-trigger="hover" class=" font-medium rounded-lg text-center inline-flex items-center" type="button">{{ __('site.blogs') }} <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            ...
                            <div id="dropdownHover" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ">
                                <ul class="py-2 text-sm text-gray-700 " aria-labelledby="dropdownHoverButton">
                                    <li>
                                        <a href="{{ route('post.index') }}" class="block px-4 py-2 hover:bg-gray-100 ">{{__('site.allblogs')}}</a>
                                    </li>
                                    @foreach (\App\Models\Category::all() as $category)
                                        <li>
                                            @if (App::isLocale('ar') && $category->name_ar != null)
                                            <a href="{{ route('post.category', $category) }}" class="block px-4 py-2 hover:bg-gray-100 ">{{$category->name_ar}}</a>                        
                                            @else
                                            <a href="{{ route('post.category', $category) }}" class="block px-4 py-2 hover:bg-gray-100 ">{{$category->name_en}}</a>
