      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            ...
            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 ">{{__('site.create')}}</span>
          </div>
        </li>
      </ol>
    </nav>
        ...
        <form class="w-full max-w-2xl mx-auto mt-12" method="POST" action="{{route('post.store')}}" enctype="multipart/form-data">
            ...
            <div class="flex flex-wrap -mx-3 mb-2">
              ...
              <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <div class="relative">
                    <select name="category[]" multiple class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
