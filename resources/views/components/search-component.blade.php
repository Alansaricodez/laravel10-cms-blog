<form action="{{route('search')}}" method="GET" role="search" class="mt-6  w-3/4 mx-auto">
    ...
    <div class="relative flex flex-row">
        ...
        <button type="submit" class="text-white  transition duration-300 hover:text-blue-700 border border-blue-700 uppercase hover:bg-white bg-blue-700  text-sm lg:text-lg font-extrabold py-1 px-2 mx-1 rounded-md">Search</button>
    </div>
</form>