<div class="flex flex-row max-w-full overflow-hidden  mx-auto md:mx-0 gap-2 my-3 bg-white p-1 md:p-3 shadow">
    ...
    <div class="mt-1 mx-2">
        ...
        <a href="{{route('post.show', $post->slug)}}">
            <h3 class="text-md lg:text-lg font-bold uppercase truncate hover:text-blue-500 ">{{\Illuminate\Support\Str::words($post->title, 15)}}</h3>
        </a>
