{{-- <div class=" shadow mx-auto overflow-hidden">
    <a href="{{route('post.show', $post->slug)}}" class="flex flex-col justify-between">
        <img class="w-full h-62 mx-auto object-fill" src="{{asset($post->getImage())}}" alt="post image" />
    </a>
...
<div class="max-w-sm rounded overflow-hidden shadow-lg flex flex-col justify-evenly">
    <a href="{{route('post.show', $post->slug)}}">
        <img class="w-full " src="{{asset($post->getImage())}}" alt="post image">
    </a>
